...
class SearchServicer:
    ...
    def PrepareIndex(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_SearchServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'PrepareIndex': grpc.unary_unary_rpc_method_handler(
                    servicer.PrepareIndex,
                    request_deserializer=search__pb2.PrepareIndexRequest.FromString,
                    response_serializer=search__pb2.PrepareIndexResponse.SerializeToString,
            ),
    }
...
class Search:
    ...
    def PrepareIndex(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/search.Search/PrepareIndex',
            search__pb2.PrepareIndexRequest.SerializeToString,
            search__pb2.PrepareIndexResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
